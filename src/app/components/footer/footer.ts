    ...
    <footer role="contentinfo">
      <div class="container footer-inner">
        <div class="footer-brand">
          <img ngSrc="logo.jpg" width="56" height="56" alt="Nulanio's Burgers" />
          <div>
            <p class="brand-name">Nulanio's Burgers</p>
            <p class="brand-tagline">Sabor Real · Hecho en Casa</p>
          </div>
        </div>
        ...
        <div class="footer-social">
          <a
            ...
            aria-label="Instagram de Nulanio's Burgers"
            class="social-icon"
          >
      ...
      <div class="footer-bottom">
        <p>&copy; 2025 Nulanio's Burgers · Todos los derechos reservados</p>
      </div>
    </footer>
  `,
  styles: [`
